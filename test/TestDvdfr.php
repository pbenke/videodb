...
*/		
		$this->assertEquals($data['title'], 'Star Wars - Episode I - La Menace Fantôme');
		$this->assertEquals($data['subtitle'], 'Star Wars: Episode I - The Phantom Menace');
		$this->assertEquals($data['year'], 1999);
		$this->assertEquals($data['coverurl'], 'http://images.dvdfr.com/images/dvd/cover_200x280/2/2869.jpg');
		...
		$this->assertMatchesRegularExpression('/Anakin Skywalker.*le jeune Obi Wan Kenobi/', $data['plot']);
